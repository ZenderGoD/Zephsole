    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">Zephsole Studio</li>
            <li className="font-mono text-xs text-foreground/80">Footwear Lab</li>
          </ul>
        </div>
      ...
      >
        <p className="font-mono text-[10px] text-muted-foreground uppercase tracking-widest">
          © 2026 Zephsole. All rights reserved.
        </p>
        <p className="font-mono text-[10px] text-muted-foreground">Engineering the future of footwear.</p>
      </div>
    </section>
  )
}
