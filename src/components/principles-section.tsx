  ...
  const principles = [
    {
      ...
      description: "Every millimeter matters. Our AI ensures patterns and lasts meet global manufacturing standards.",
      align: "left",
    },
    {
      number: "02",
      titleParts: [
        ...
        { text: " COST CONTROL", highlight: false },
      ],
      description: "Instant material calculations. Know your margins before the first prototype is ever cut.",
      align: "right",
    },
    {
      number: "03",
      ...
      description: "From upper design to lacing logic. A complete digital pipeline for modern footwear brands.",
      align: "left",
    },
    {
      number: "04",
